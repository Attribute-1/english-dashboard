...
const App = () => {
  ...
  const skillData = [
    ...
    { 
      ...
      tip: 'Записывай свои ответы на диктофон и слушай их. Сначала будет странно, но это лучший способ услышать свои "эээ" и исправить их. Ты будущий оратор! 🎤😎'
    },
    { 
      subject: 'Чтение', 
      A: 50, B: 80, 
      ...
      tip: 'Не пытайся перевести каждое слово. Ищи зацепки (местоимения, союзы), которые связывают части текста. Прямо как детектив! 🔍📚'
    },
    { 
      subject: 'Письмо', 
      A: 35, B: 65, 
